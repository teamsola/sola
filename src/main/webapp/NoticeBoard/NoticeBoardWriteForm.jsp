...
<body>
	...
	<div id="aa">공지사항 글작성</div>
	<hr id="line1">

	<form action="NoticeBoardWrite.do" method="post" id="insertBoardFrm" name="insertBoardForm" enctype="multipart/form-data">
	...
	<div style="float:left; width:100%; text-align: center;">
		...
		<tr>	
        	<td id="contents" colspan="2"><textarea name="content" class="editor" id="noticewritecontent" style="width: 100%; height: 400px;"></textarea>
        </tr>
        ...
        <div id="btnset">
        	<input type="button" id="insertBoard" value="등록" />
      		<input type="button" id="btn" value="취소" onclick="location.href='NoticeBoardList.do'">
      		<!-- 엔터키막기 -->
