...
<script type="text/javascript">
	$(function(){
	    ...
	    nhn.husky.EZCreator.createInIFrame({
	        oAppRef: obj,
	        elPlaceHolder: "noticemodifycontent",
	    ...
	    $("#modifyBoard").click(function(){
	         obj.getById["noticemodifycontent"].exec("UPDATE_CONTENTS_FIELD", []);
	       
	         if($("#subject").val()==""){
	        	 alert("제목을 입력하세요");
	        	 $("#subject").focus();
	         }else if($("#noticemodifycontent").val()=="" || $("#noticemodifycontent").val()=='<p>&nbsp;</p>'){
	        	 alert("내용을 입력하세요");
	        	 $("#noticemodifycontent").focus();
	       	}else{
...
<body>
	...
	<div id="aa">공지사항 글수정</div>
	<hr id="line1">

	<form action="NoticeBoardModify.do" method="post" id="modifyBoardFrm" name="modifyBoardForm" enctype="multipart/form-data">
	...
	<div style="float:left; width:100%; text-align: center;">
		...
		<tr>	
        	<td id="contents" colspan="2"><textarea name="content" class="editor" id="noticemodifycontent" style="width: 100%; height: 400px;">${boardDTO.content }</textarea>
        </tr>
        ...
        <div id="btnset">
        	<input type="button" id="modifyBoard" value="수정" />
      		<input type="button" id="btn" value="취소" onclick="javascript:goBack();">
