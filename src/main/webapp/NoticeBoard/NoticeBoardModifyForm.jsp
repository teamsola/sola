...
<body>
<div id="title">
	<label for="page">공지사항 글수정</label>
</div>
<div id="body">
	<form action="NoticeBoardModify.do" method="post" id="modifyBoardForm" name="modifyBoardForm">
		...
		<div><textarea name="content" id="noticemodifycontent" >${boardDTO.content }</textarea></div>
