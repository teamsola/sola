...
<script type="text/javascript">
	$(function(){
	    ...
	    nhn.husky.EZCreator.createInIFrame({
	        oAppRef: obj,
	        elPlaceHolder: "freewritecontent",
	    ...
	    $("#insertBoard").click(function(){
	         obj.getById["freewritecontent"].exec("UPDATE_CONTENTS_FIELD", []);
	       
	         if($("#subject").val()==""){
	        	 alert("제목을 입력하세요");
	        	 $("#subject").focus();
	         }else if($("#freewritecontent").val()=="" || $("#freewritecontent").val()=='<p>&nbsp;</p>'){
	        	 alert("내용을 입력하세요");
	        	 $("#freewritecontent").focus();
	       	}else{
...
<body>
	...
	<div id="aa">자유게시판 글작성</div>
	<hr id="line1">

	<form action="FreeBoardWrite.do" method="post" id="insertBoardFrm" name="insertBoardForm" enctype="multipart/form-data">
	...
	<div style="float:left; width:100%; text-align: center;">
		...
		<tr>	
        	<td id="contents" colspan="2"><textarea name="content" class="editor" id="freewritecontent" style="width: 100%; height: 400px;"></textarea>
        </tr>
        ...
        <div id="btnset">
        	<input type="button" id="insertBoard" value="등록" />
      		<input type="button" id="btn" value="취소" onclick="location.href='FreeBoardList.do'">
      		<!-- 엔터키막기 -->
