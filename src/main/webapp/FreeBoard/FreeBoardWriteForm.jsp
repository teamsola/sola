...
<body>
<div id="title">
	<label for="page">자유게시판 글쓰기</label>
</div>
<div id="body">
	<form action="FreeBoardWrite.do" method="post" id="insertBoardForm" name="insertBoardForm">
		...
		<div><textarea name="content" id="freewritecontent"></textarea></div>
		<div id="btn_submit"><input type="button" id="insertBoard" name="insertBoard" value="등록"/></div>
		<!-- 엔터키막기 -->
