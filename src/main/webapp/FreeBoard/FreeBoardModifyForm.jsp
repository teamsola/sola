...
<body>
	...
	<div id="aa">자유게시판 글수정</div>
	<hr id="line1">

	<form action="FreeBoardModify.do" method="post" id="modifyBoardFrm" name="modifyBoardForm" enctype="multipart/form-data">
	...
	<div style="float:left; width:100%; text-align: center;">
		...
		<tr>	
        	<td id="contents" colspan="2"><textarea name="content" class="editor" id="freemodifycontent" style="width: 100%; height: 400px;">${boardDTO.content }</textarea>
        </tr>
